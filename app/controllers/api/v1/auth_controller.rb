class Api::V1::AuthController < ApplicationController
    def create
        ...
        userRollSums = {two: rollSumArr.sum(:two), three: rollSumArr.sum(:three), four: rollSumArr.sum(:four), five: rollSumArr.sum(:five), six: rollSumArr.sum(:six), seven: rollSumArr.sum(:seven), eight: rollSumArr.sum(:eight), nine: rollSumArr.sum(:nine), ten: rollSumArr.sum(:ten), eleven: rollSumArr.sum(:eleven), twelve: rollSumArr.sum(:twelve), totalRolls: rollSumArr.sum(:totalRolls)}
