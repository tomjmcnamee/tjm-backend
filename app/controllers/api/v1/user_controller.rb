class Api::V1::UserController < ApplicationController
    def create
        ...
        if userObj.save
            ShutTheBoxGame.create(user_id: userObj.id)
            ShutTheBoxDiceRoll.create(user_id: userObj.id)
            ShutTheBoxRollSum.create(user_id: userObj.id)
